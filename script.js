...
boxSelector.forEach(a => {
    a.addEventListener("click", a => {
        ...
        // console.log("pressed");
        // console.log(a.srcElement.classList == "clickedPrev" || a.srcElement.classList == "clicked");
        // console.log(a.srcElement.id);
...
function tryAgain() {
    ...
    function assigner() {
        ...
        switch (true) {
            ...
            default:
                return "Oh...It's Okay, did you there is a 'console' which can be opened using 'F12'";
        }
...
function nextStage() {
    flexBox.style.display = "none";
    nextSection.classList.add("nextStage");
